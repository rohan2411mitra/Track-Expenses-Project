          ...
          child: Form(
            ...
            child: Column(
              children: <Widget>[
                ...
                const Text('Enter your registered Email to receive reset password link',
  ...
  Future resetPassword() async{
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("Password Reset Email Sent!", textAlign: TextAlign.center),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(e.message ?? "Some Error Occured!", textAlign: TextAlign.center),
            duration: Duration(seconds: 5),
